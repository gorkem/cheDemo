...
public class CheDemoApp {

    private static final Logger log = LoggerFactory.getLogger(CheDemoApp.class);

    private final Environment env;

    public CheDemoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CheDemoApp.class);
